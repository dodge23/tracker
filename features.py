...
def create_tables():
    ...
    cursor.execute('''CREATE TABLE IF NOT EXISTS ip_tracking (
    ...
    cursor.execute('''CREATE TABLE IF NOT EXISTS phone_tracking (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        phone TEXT NOT NULL,
        data TEXT,
        timestamp DATETIME DEFAULT CURRENT_TIMESTAMP
...
class TrackerApp:
    def __init__(self, root):
        ...
        # Create Clear button to clear the results
    ...
    def phoneGW(self):
        ...
        try:
            ...
            # Simulated coordinates for demonstration; replace with real data if available
            latitude = "Unknown"  # Placeholder
            longitude = "Unknown"  # Placeholder
            ip_address = "Unknown"  # Placeholder for the IP address associated with this number

            phone_info = (
                f"Number: {parsed_number}\n"
    ...
    def clear_results(self):
        self.result_text.delete('1.0', tk.END)  # Clear the results display
        self.ip_entry.delete(0, tk.END)  # Clear the IP entry field
        self.phone_entry.delete(0, tk.END)  # Clear the phone entry field
